...
function spawnPoint.create(zone, required, existingPoint, vehicleTypes)
    ...
    [X]: Fechar
    [Enter]: Confirmar
    [Spacebar]: Adicionar Pontos
    [Arrow Up/Down]: Altura
    [Arrow Right/Left]: Girar Veículo
    [Backspace]: Excluir Ponto
    [Mouse Scroll Up/Down]: Alterar Tipo (Atual: %s)
    [LShift + Mouse Scroll Up/Down]: Alterar Modelo (Atual: %s)
    ]]
